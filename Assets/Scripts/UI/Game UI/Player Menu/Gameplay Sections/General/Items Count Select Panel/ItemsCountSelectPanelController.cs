...
public class ItemsCountSelectPanelController : MonoBehaviour
{
    [SerializeField]
    ...
    public ItemsCountSelectPanelController(InputManager inputManager)
    {
    ...
    public void CreateItemsCountChoiceView(string interactionDescription, StackableItemState stackableItem, int minItemsCount, int maxItemsCount, ItemsCountChoiceData possibleActions)
    {
        ...
        _inputManager.CurrentActionMap = PlayerInputActionMap.PlayerMenu_ItemsCountChoiceView;
    }
    ...
    {
        var itemsCountChoiceInputActions = _inputManager.PlayerActions.PlayerMenuChooseItemsCountView;
        ...
        return actionButtonParams
            .Select(actionButtonData => (_inputManager.CreateDetailedControlsTip((actionButtonData.name, actionButtonData.inputAction)), actionButtonData.buttonPressedAction))
            .ToList();
    }
}
