...
{
    [SerializeField]
    private ItemCellNavigationModule leftNeighboringCell;
    [SerializeField]
    private ItemCellNavigationModule rightNeighboringCell;
    [SerializeField]
    private ItemCellNavigationModule topNeighboringCell;
    [SerializeField]
    private ItemCellNavigationModule bottomNeighboringCell;
