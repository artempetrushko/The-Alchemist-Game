...
namespace GameLogic.LevelLoading
{
    public class LevelLoadingView : MonoBehaviour
    {
        ...
        [SerializeField] private RectTransform _progressBarFillAreaContainerRect;
        ...
        {
            _progressBarFillArea.rectTransform.sizeDelta = new Vector2(_progressBarFillAreaContainerRect.rect.width * (loadingProgress + 0.1f), _progressBarFillArea.rectTransform.rect.height);
        }
