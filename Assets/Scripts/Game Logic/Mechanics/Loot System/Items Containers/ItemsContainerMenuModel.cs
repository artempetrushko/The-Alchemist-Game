...
namespace GameLogic.EnvironmentExploration
{
    public class ItemsContainerMenuModel
    {
        ...
        public readonly (ItemState item, ContainedItemView itemView)[] ContainedItems;
        ...
        public ItemsContainerMenuModel(ItemsContainer itemsContainer, (ItemState item, ContainedItemView itemView)[] containedItems)
        {
