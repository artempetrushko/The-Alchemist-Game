...
namespace GameLogic.PlayerMenu
{
    public class ItemsInteractionsPanelPresenter : IDisposable
    {
        ...
        private PlayerMenuItemSlotActionsMenuActionMap _actionMap;
        private InputManager _inputManager;
        private SignalBus _signalBus;

        public ItemsInteractionsPanelPresenter(ItemsInteractionsPanelView view, PlayerMenuItemSlotActionsMenuActionMap actionMap, InputManager inputManager, SignalBus signalBus)
        {
            _view = view;
            ...
            _inputManager.PlayerActions.PlayerMenuItemCellActionsMenu.Navigate.performed += OnNavigateInteractionsActionPerformed;
            _inputManager.PlayerActions.PlayerMenuItemCellActionsMenu.Select.performed += OnSelectInteractionActionPerformed;
            _inputManager.PlayerActions.PlayerMenuItemCellActionsMenu.CloseItemCellActionsMenu.performed += OnCloseItemsInteractionsPanelActionPerformed;
