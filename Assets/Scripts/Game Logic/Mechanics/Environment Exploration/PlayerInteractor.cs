...
namespace GameLogic.Player
{
    public class PlayerInteractor : MonoBehaviour
    {
        ...
        private void OnInteractActionPerformed(InputAction.CallbackContext context) => _signalBus.Fire(new ObjectInteractionStartedSignal(_currentInteractiveObject));
    }
}