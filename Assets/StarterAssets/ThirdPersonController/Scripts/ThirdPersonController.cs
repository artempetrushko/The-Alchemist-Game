...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            if (_input.block)
            {
                var position = _input.aim;
                var currentPosition = _mainCamera.ScreenToWorldPoint(position);
                var lookPosition = currentPosition - _transform.position;
                lookPosition.y = 0;
                _transform.rotation=Quaternion.LookRotation(lookPosition);
            }
